...
class Grille:  # Classe qui gere la grille
    ...
    def __init__(self, screen):
        ...
        self.surface_grille.fill((0, 0, 0))
        '''
    ...
    def afficher_grille(self):
        ...
        #fond de la grille en noir (surface à utiliser pour les cases)

        self.surface_grille = pygame.Surface([645,645])
        self.surface_grille.fill((0,0,0))
        self.screen.blit(self.surface_grille,(440,100))

        """surface_case = pygame.draw.rect(surface_grille, (255,0,0), ([0,0,75,75]))
        surface_case"""
